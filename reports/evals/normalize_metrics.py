...
df_normalized['AVGFACT'] = df_normalized[['ROUGE', 'BLEU', 'METEOR', 'BERTScore']].mean(axis=1)
...
# define column order
column_order = ['ROUGE', 'BLEU', 'METEOR', 'BERTScore', 'AVGFACT', 'FKGL', 'DCRS', 'CLI', 'AVGRD', 'AlignScore', 'SummaC', 'AVGREL', 'TOTAVG']
