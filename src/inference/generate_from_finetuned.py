...
MODEL_CONFIGS = {
    ...
    "elife_fulltext_dola": {
        "adapter_path": "/gscratch/scrubbed/yongsinp/biolaysumm2025-task/models/finetuned_whopriyam2_SUWMIT_dataset_extractive_length_20_train_elife_BioBERT_llama_3.1_8b_instruct/epoch_7",
        "output_path": "/gscratch/stf/jcols/biolaysum_summaries/finetuned_fulltext_dola_{split}_elife.jsonl",
        "checkpoint_path": "/gscratch/stf/jcols/biolaysum_summaries/finetuned_fulltext_dola_{split}_elife.ckpt",
        "dataset_split": "extractive/length_20/{split}_elife_BioBERT.csv",
        "input_field": "article",
        "batch_size": 1,
        "max_new_tokens": 384,
    ...
    "elife_fulltext_greedy": {
        "adapter_path": "/gscratch/scrubbed/yongsinp/biolaysumm2025-task/models/finetuned_whopriyam2_SUWMIT_dataset_extractive_length_20_train_elife_BioBERT_llama_3.1_8b_instruct/epoch_7",
        "output_path": "/gscratch/stf/jcols/biolaysum_summaries/finetuned_fulltext_greedy_{split}_elife.jsonl",
        "checkpoint_path": "/gscratch/stf/jcols/biolaysum_summaries/finetuned_fulltext_greedy_{split}_elife.ckpt",
        "dataset_split": "extractive/length_20/{split}_elife_BioBERT.csv",
        "input_field": "article",
        "batch_size": 1,
        "max_new_tokens": 384,
